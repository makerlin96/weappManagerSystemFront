<template>
  <el-dialog
    ...
    width="40%"
  >
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="130px" style="width:90%;" @keyup.enter.native="dataFormSubmit()">
      <el-form-item size="mini" label="存储类型">
        <el-radio-group v-model="dataForm.type">
          ...
          <el-radio :label="4">腾讯云</el-radio>
        </el-radio-group>
      </el-form-item>
      <template v-if="dataForm.type === 1">
        <el-form-item label="上传目录">
          <el-input v-model="dataForm.qiniuPrefix" placeholder="例如C:/uploads" />
        </el-form-item>
      </template>
